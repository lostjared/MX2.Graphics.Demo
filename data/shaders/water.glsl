...
void main(void) {
    ...
    float ripple = sin(TexCoord.x * wavelength + time * speed) * amplitude;
    ripple += sin(TexCoord.y * wavelength + time * speed) * amplitude;
    ...
    vec4 mixResult = mix(originalColor, rippleColor, 0.5);
