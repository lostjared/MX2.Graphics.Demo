...
void main(void) {
    ...
    float gliTexCoordhFactor = sin(time);
    vec2 gliTexCoordhOffset = vec2(gliTexCoordhFactor * 0.1 * iAmplitude, gliTexCoordhFactor * 0.1);
    ...
    vec4 mixResult = mix(baseColor, gliTexCoordhColor, 0.5);
