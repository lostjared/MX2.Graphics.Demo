...
void main(void) {
    ...
    vec2 twistClockwise = twist(centeredCoord, 15.0, time, 1.0);

    vec2 twistCounterClockwise = twist(centeredCoord, 15.0, time, -1.0);
    ...
    vec4 mixResult = mix(texColorClockwise, texColorCounterClockwise, 0.5);
